...
export function BrandsList() {
    const [types, setTypes] = useState<BrandDevive[]>([]);
    ...
    return (
        <Card backgroundColor='whiteAlpha.700' flexDirection='column' w='100%' px='0px' overflowX={{ sm: 'scroll', lg: 'hidden' }} padding='20px 20px'>
			<Flex px='25px' justify='space-between' mb='20px' align='center'>
                ...
                <Spacer />
                <Button colorScheme='blue' size='sm'  onClick={() =>  navigate(`/nova_marca/`)}>
                    Novo
                </Button> 
			</Flex>
            <TableContainer>
                <Table variant='simple' color='gray.500' mb='24px'>
                    ...
                    types.map((type) => (
                        ...
                        <ConfirmButton
                            ...
                            isDanger={true}
                        />
                            <Button ml='5px' colorScheme='blue' size='xs' onClick={() => navigate(`/nova_marca/${type.id}`)}>
                                Editar
                            </Button>                  
                        </Td>
