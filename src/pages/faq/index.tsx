import {
  ...
  export default function FAQ() {
    const { hasCopied, onCopy } = useClipboard('prussdev@gmail.com');
            ...
            <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
              ...
              <Stack
                ...
                <Stack
                  ...
                  <Link href="https://github.com/MauricioPDuarte">
                    <IconButton
                      aria-label="github"
                      variant="ghost"
                      size="lg"
                  ...
                  <Link href="https://www.linkedin.com/in/mauriciopd/">
                    <IconButton
                      aria-label="linkedin"
                      variant="ghost"
                      size="lg"
                ...
                <Box
                  ...
                  shadow="base">
                    <Text mb={4} fontSize={16}>Olá, bem vindo ao FAQ do MPSchemas. Espero que possamos ajudar você!</Text>
                    <Divider />
                  <VStack  spacing={5} alignItems='left' mt={10}>
                     
             
                     <Text  textAlign='left'  fontSize={16} fontWeight={500}>O que é o MPSChemas?</Text>
                     <Text fontSize={16} fontWeight={300}>O MPSchemas ajuda você a centralizar todos os seus esquemas elétricos, de forma a agilizar<br/> seus serviços e garantindo uma maior produtividade no seu dia a dia.</Text>

                  </VStack>
                  <Stack mt={10}>
                    <Text  textAlign='left'  fontSize={16} fontWeight={500}>Tem algum limite de esquemas que posso cadastrar?</Text>
                     <Text fontSize={16} fontWeight={300}>O MPSchemas não bloqueia seus cadastros, você está livre para usar da forma que achar melhor.</Text>
                  </Stack>
                  <Stack mt={10}>
                    <Text  textAlign='left'  fontSize={16} fontWeight={500}>Como faço para cadastrar itens novos?</Text>
                     <Text fontSize={16} fontWeight={300}>Basta você acessar o menu lateral e clicar em cima do item desejado, depois basta clicar em "novo".</Text>
                  </Stack>
                </Box>
              </Stack>
            </VStack>
